...
<?php
    ...
    while ($db_record = mysqli_fetch_assoc($result)) { 
        ...
        echo "<div>";
        ?>
        <a href='item-auth/product.php?itemId=<?php echo $db_record['item_id'] ?>'>
        ...
        ?>
        <p><strong>Title:</strong> <a href='item-auth/product.php?itemId=<?php echo $db_record['item_id'] ?>'><?php echo $db_record['title'] ?></p></a>
